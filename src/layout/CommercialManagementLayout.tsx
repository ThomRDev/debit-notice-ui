...
export const CommercialManagementLayout = () => {
  ...
  return (
    <div className="flex flex-col w-full md:w-[700px] mx-auto shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
      ...
      <nav className="px-7 py-3">
        <div className="flex ">
          ...
          <Link
            ...
            className={`hover:text-[#1E68CA]  hover:font-bold transition-all w-[25%] text-center ${
          ...
          <Link
            ...
            className={`hover:text-[#1E68CA] hover:font-bold transition-all w-[15%] text-center ${
